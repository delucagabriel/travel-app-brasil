...
export const BaseClosureDetails = ({requestDetails, children=null})=>{
            ...
            <Grid xs={12} sm={12} md={6} lg={6} xl={6} style={{padding:'10px'}}>
              <Grid container>
                  ...
                  <ListItem >
                    <Grid xs={12} sm={12} md={6} lg={6} xl={6}>
                      <ListItemText primaryTypographyProps={{color:"secondary"}}
                      primary="ÚLTIMA MEDIÇÃO: DE" secondary={requestDetails.PERIODO_INICIO}/>
                    </Grid>
                    <Grid xs={12} sm={12} md={6} lg={6} xl={6}>
                      <ListItemText primaryTypographyProps={{color:"secondary"}}
                      primary="ÚLTIMA MEDIÇÃO: ATÉ" secondary={requestDetails.PERIODO_FIM}/>
                    </Grid>
                  </ListItem>
                  <ListItem >
