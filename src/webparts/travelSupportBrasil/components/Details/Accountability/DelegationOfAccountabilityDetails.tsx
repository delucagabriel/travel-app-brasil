...
export const DelegationOfAccountabilityDetails = ({requestDetails, children=null})=>{
  return(
    <>
            ...
            <Grid xs={12} sm={12} md={6} lg={6} xl={6} style={{padding:'10px'}}>
              ...
              <ListItem >
                  <Grid xs={12} sm={12} md={6} lg={6} xl={6}>
                    ...
                    primary="DELEGANTE: MATRICULA" secondary={requestDetails.DONO_DA_DESPESA_ID}/>
                  </Grid>
                  <Grid xs={12} sm={12} md={6} lg={6} xl={6}>
                    <ListItemText primaryTypographyProps={{color:"secondary"}}
                    primary="DELEGANTE: NOME" secondary={requestDetails.DONO_DA_DESPESA_NOME}/>
                  </Grid>
                </ListItem>
                <ListItem >
                  <Grid xs={12} sm={12} md={6} lg={6} xl={6}>
                    <ListItemText primaryTypographyProps={{color:"secondary"}}
                    primary="DELEGANTE: EMAIL" secondary={requestDetails.DONO_DA_DESPESA_EMAIL}/>
                  </Grid>
                  <Grid xs={12} sm={12} md={6} lg={6} xl={6}>
                    <ListItemText primaryTypographyProps={{color:"secondary"}}
                    primary="DELEGANTE: EMPRESA" secondary={requestDetails.DONO_DA_DESPESA_EMPRESA_NOME}/>
                  </Grid>
                </ListItem>
                <ListItem >
                  <Grid xs={12} sm={12} md={12} lg={12} xl={12}>
                    <ListItemText primaryTypographyProps={{color:"secondary"}}
                    primary="DELEGANTE: LEVEL" secondary={requestDetails.DONO_DA_DESPESA_LEVEL}/>
                  </Grid>
                </ListItem>
                ...
                <ListItem >
                  <Grid xs={12} sm={12} md={6} lg={6} xl={6}>
                    <ListItemText primaryTypographyProps={{color:"secondary"}}
                    primary="DELEGADO: MATRICULA" secondary={requestDetails.BENEFICIARIO_ID}/>
                  </Grid>
                  <Grid xs={12} sm={12} md={6} lg={6} xl={6}>
                    <ListItemText primaryTypographyProps={{color:"secondary"}}
                    primary="DELEGADO: NOME" secondary={requestDetails.BENEFICIARIO_NOME}/>
                  </Grid>
                </ListItem>
                <ListItem >
                  <Grid xs={12} sm={12} md={6} lg={6} xl={6}>
                    <ListItemText primaryTypographyProps={{color:"secondary"}}
                    primary="DELEGADO: EMAIL" secondary={requestDetails.BENEFICIARIO_EMAIL}/>
                  </Grid>
                  <Grid xs={12} sm={12} md={6} lg={6} xl={6}>
                    <ListItemText primaryTypographyProps={{color:"secondary"}}
                    primary="DELEGADO: EMPRESA" secondary={requestDetails.BENEFICIARIO_EMPRESA_NOME}/>
                  </Grid>
                </ListItem>
                <ListItem >
                  <Grid xs={12} sm={12} md={12} lg={12} xl={12}>
                    <ListItemText primaryTypographyProps={{color:"secondary"}}
                    primary="DELEGADO: LEVEL" secondary={requestDetails.BENEFICIARIO_LEVEL}/>
                  </Grid>
                </ListItem>
                ...
                <ListItem >
                  <Grid xs={12} sm={12} md={6} lg={6} xl={6}>
                    <ListItemText primaryTypographyProps={{color:"secondary"}}
                    primary="TIPO DE DELEGAÇÃO" secondary={requestDetails.TIPO_DE_DELEGACAO}/>
                  </Grid>
                  <Grid xs={12} sm={12} md={6} lg={6} xl={6}>
                    <ListItemText primaryTypographyProps={{color:"secondary"}}
                    primary="PERÍODO" secondary={requestDetails.PERIODO_FIM}/>
                  </Grid>
                </ListItem>
