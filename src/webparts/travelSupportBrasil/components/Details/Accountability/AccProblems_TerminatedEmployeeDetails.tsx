...
export const AccProblems_TerminatedEmployeeDetails = ({requestDetails, children=null})=>{
  return(
    <>
              ...
              <Grid container>
                ...
                <ListItem >
                  <Grid xs={12} sm={6} md={6} lg={6} xl={6}>
                    <ListItemText primaryTypographyProps={{color:"secondary"}}
                    primary="TIPO DE PRESTAÇÃO DE CONTAS" secondary={requestDetails.TIPO_PRESTACAO_DE_CONTAS}/>
                  </Grid>
                  <Grid xs={12} sm={6} md={6} lg={6} xl={6}>
                    <ListItemText primaryTypographyProps={{color:"secondary"}}
                    primary="RELATÓRIO CONCUR" secondary={requestDetails.RELATORIO_CONCUR}/>
                  </Grid>
                </ListItem>
