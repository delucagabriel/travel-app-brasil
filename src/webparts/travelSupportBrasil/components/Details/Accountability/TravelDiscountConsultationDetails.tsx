...
export const TravelDiscountConsultationDetails = ({requestDetails, children=null})=>{
  return(
    <>
              ...
              <Grid container>
                ...
                <ListItem >
                  <Grid xs={12} sm={12} md={12} lg={12} xl={12}>
                    <ListItemText primaryTypographyProps={{color:"secondary"}}
                    primary="CÓDIGO NO CONTRACHEQUE" secondary={requestDetails.COD_DO_DESCONTO_NO_CONTRACHEQUE}/>
                  </Grid>
                </ListItem>
                <ListItem >
                  <Grid xs={12} sm={12} md={6} lg={6} xl={6}>
                    <ListItemText primaryTypographyProps={{color:"secondary"}}
                    primary="DATA DO DESCONTO" secondary={requestDetails.DATA_DO_DESCONTO}/>
                  </Grid>
                  <Grid xs={12} sm={12} md={6} lg={6} xl={6}>
                    <ListItemText primaryTypographyProps={{color:"secondary"}}
