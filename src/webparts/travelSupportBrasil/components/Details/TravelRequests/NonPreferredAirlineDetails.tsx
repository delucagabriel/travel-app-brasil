...
export const NonPreferredAirlineDetails = ({requestDetails, children=null})=>{
  return(
    <>
            ...
            <Grid xs={12} sm={12} md={6} lg={6} xl={6} style={{padding:'10px'}}>
              <Grid container>
                ...
                <ListItem >
                  <Grid xs={12} sm={12} md={6} lg={6} xl={6}>
                    <ListItemText primaryTypographyProps={{color:"secondary"}}
                    primary="ORIGEM" secondary={requestDetails.VIAGEM_ORIGEM}/>
                  </Grid>
                  <Grid xs={12} sm={12} md={6} lg={6} xl={6}>
                    <ListItemText primaryTypographyProps={{color:"secondary"}}
                      primary="DESTINO" secondary={requestDetails.VIAGEM_DESTINO}/>
                  </Grid>
                </ListItem>
                ...
                <ListItem >
                  <Grid xs={12} sm={12} md={6} lg={6} xl={6}>
                    <ListItemText primaryTypographyProps={{color:"secondary"}}
                    primary="Nº VOO" secondary={requestDetails.OS_AGENCIA}/>
                  </Grid>
                  <Grid xs={12} sm={12} md={6} lg={6} xl={6}>
                    <ListItemText primaryTypographyProps={{color:"secondary"}}
                      primary="TARIFA" secondary={requestDetails.VALOR}/>
                  </Grid>
                </ListItem>
                ...
                <ListItem >
                  <Grid xs={12} sm={12} md={6} lg={6} xl={6}>
                    <ListItemText primaryTypographyProps={{color:"secondary"}}
                    primary="Data de embarque" secondary={requestDetails.DATA_DE_UTILIZACAO}/>
                  </Grid>
                  <Grid xs={12} sm={12} md={6} lg={6} xl={6}>
                    <ListItemText primaryTypographyProps={{color:"secondary"}}
                    primary="HORÀRIO DO VOO" secondary={requestDetails.HORARIO}/>
                  </Grid>
                </ListItem>
                ...
                <ListItem >
                  <Grid xs={12} sm={12} md={12} lg={12} xl={12}>
                    <ListItemText primaryTypographyProps={{color:"secondary"}}
                    primary="JUSTIFICATIVA" secondary={requestDetails.MOTIVO && requestDetails.MOTIVO && requestDetails.MOTIVO.replace(/(&nbsp;|<([^>]+)>)/ig, '')}/>
                  </Grid>
                </ListItem>
