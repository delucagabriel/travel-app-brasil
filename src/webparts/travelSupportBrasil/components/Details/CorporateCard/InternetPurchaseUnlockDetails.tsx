...
export const InternetPurchaseUnlockDetails = ({requestDetails, children=null})=>{
            ...
            <Grid xs={12} sm={12} md={6} lg={6} xl={6} style={{padding:'10px'}}>
              <Grid container>
                  ...
                  <ListItem >
                    ...
                    <Grid xs={12} sm={6} md={6} lg={6} xl={6}>
                      <ListItemText primaryTypographyProps={{color:"secondary"}}
                      primary="CÓD. RAMO DE ATIVIDADE" secondary={requestDetails.COD_DO_RAMO_DE_ATIVIDADE}/>
                    </Grid>
                  </ListItem>
