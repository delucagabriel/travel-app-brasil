            ...
            <Grid xs={12} sm={12} md={6} lg={6} xl={6} style={{padding:'10px'}}>
              <Grid container>
                  ...
                  <ListItem >
                    <Grid xs={12} sm={6} md={6} lg={6} xl={6}>
                      <ListItemText primaryTypographyProps={{color:"secondary"}}
                      primary="TIPO DE LIMITE" secondary={requestDetails.TIPO_DE_LIMITE}/>
                    </Grid>
                    { requestDetails && requestDetails.TIPO_DE_LIMITE === 'Saque'
                      ?<Grid xs={12} sm={6} md={6} lg={6} xl={6}>
                        <ListItemText primaryTypographyProps={{color:"secondary"}}
                  ...
                  <ListItem >
                    <Grid xs={12} sm={6} md={6} lg={6} xl={6}>
                      <ListItemText primaryTypographyProps={{color:"secondary"}}
                      primary="VENCIMENTO DO NOVO LIMITE" secondary={requestDetails.VALIDADE_NOVO_LIMITE}/>
                    </Grid>
                  </ListItem>
