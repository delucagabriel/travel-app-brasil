  ...
  return (
    <Paper>
      ...
      <Typography variant='h6'>
        ...
        <Typography variant='body2'>
          Empregados portadores de cartão corporativo devem solicitar o reembolso através de saque. Caso o sistema esteja informando indevidamente que o empregado é portador de cartão, preencha o formulário a seguir.
          <br/>
          Para dúvidas sobre como prestar contas de recursos próprio, consulte os materiais de apoio disponíveis na intranet, em Institucional e serviços > Viagens > Prestação de contas de viagens e cartões.
        </Typography>
