...
export default function ActiveEmployeeReimbursement() {
    ...
    <Paper>
      <HocDialog>
        <Typography variant='body2'>
          O reembolso é efetuado na conta bancária do empregado em até 5 dias após a aprovação do relatório, pelo Contas a Pagar.<br/>
          Não é possível realizar pagamentos de reembolso em co​nta tipo salário. Neste caso, o empregado poderá solicitar o cadastro de uma conta corrente ao RH.
        </Typography>
      </HocDialog>
        ...
        <Grid container spacing={3} justify="space-between">
          ...
          <Grid item xs={12} sm={6} md={6} lg={6} xl={6}>
            ...
            <Controller
              as={
                <Select disabled fullWidth >
                  <MenuItem value="Pagamento de reembolso (Empregado ativo)">{"Pagamento de reembolso (Empregado ativo)"}</MenuItem>
                </Select>
              }
              id="Process"
              name="PROCESSO"
              defaultValue="Pagamento de reembolso (Empregado ativo)"
              control={control}
