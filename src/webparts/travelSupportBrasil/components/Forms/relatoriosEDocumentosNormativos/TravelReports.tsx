...
const schema: yup.ObjectSchema<IRequests_AllFields> = yup.object().shape({
  ...
  TIPO_DE_SOLICITACAO: yup.string().required(),
});
  ...
  return (
    <Paper>
      <HocDialog>
        ...
        Os relatórios de viagens estão disponíveis no Power BI: https://app.powerbi.com/groups/me/apps/9b1e1be9-a098-4fdf-bdce-dfad0286ca5c/reports/fd3cfbc0-7196-4636-aad4-d32e5f501c6e/ReportSection9763eea00d6750a672c0.
        <br/>
        Todos os gestores possuem acesso automático ao dashboard. Demais empregados devem preencher este formulário.
        </Typography>
      </HocDialog>
        ...
        <Grid container spacing={3} justify="space-between">
            ...
            <Controller
              as={
                <Select disabled fullWidth>
                  <MenuItem value="Documentos normativos e relatórios"> Documentos normativos e relatórios </MenuItem>
                </Select>
              }
              name="MACROPROCESSO"
          ...
          <Grid item xs={12} sm={6} md={6} lg={6} xl={6}>
            ...
            <Controller
              as={
                <Select disabled fullWidth >
                  <MenuItem value="Relatórios de viagens">{"Relatórios de viagens"}</MenuItem>
                </Select>
              }
              id="Process"
              name="PROCESSO"
              defaultValue="Relatórios de viagens"
              control={control}
          ...
          <Grid item xs={12} sm={12} md={12} lg={12} xl={12}>
            <FormControl component="fieldset" error={errors.TIPO_DE_SOLICITACAO?true:false}>
            <FormLabel component="legend">Tipo solicitação </FormLabel>
            <RadioGroup aria-label="TIPO_DE_SOLICITACAO" name="TIPO_DE_SOLICITACAO"
            row>
              <FormControlLabel value="Solicitação de acesso" control={<Radio inputRef={register}/>} label="Solicitação de acesso" />
              <FormControlLabel value="Dúvidas sobre o relatório" control={<Radio inputRef={register}/>} label="Dúvidas sobre o relatório" />
            </RadioGroup>
            </FormControl>
          </Grid>
          ...
          <Grid item xs={12} sm={12} md={12} lg={12} xl={12} >
            ...
            multiline rows={5}
            name="MOTIVO" label="Descrição da solicitação" inputRef={register}
