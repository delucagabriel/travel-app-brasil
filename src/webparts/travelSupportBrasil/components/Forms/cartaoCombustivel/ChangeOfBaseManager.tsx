...
export default function ChangeOfBaseManager(){
          ...
          <Grid container spacing={3} justify="space-between">
            ...
            <Grid item xs={12} sm={6} md={6} lg={6} xl={6}>
              ...
              <Controller
                as={
                  <Select disabled fullWidth>
                    <MenuItem value="Alteração de gestor de base">Alteração de gestor de base</MenuItem>
                  </Select>
                }
                id="Process"
                name="PROCESSO"
                defaultValue="Alteração de gestor de base"
                control={control}
              />
            </Grid>
            ...
            <Grid item xs={12} sm={4} md={4} lg={4} xl={4} >
                <TextField
                  ...
                  label="Novo gestor de base: Matrícula"
              ...
              <Grid item xs={12} sm={8} md={8} lg={8} xl={8} >
                <TextField
                  ...
                  label="Novo gestor de base: e-mail"
                  variant="outlined"
                  inputRef={register}
              ...
              <Grid item xs={12} sm={12} md={12} lg={12} xl={12} >
                <TextField disabled fullWidth type="text" name="BENEFICIARIO_NOME"
                  label="Novo gestor de base: Nome" variant="outlined"
                  inputRef={register}
                  InputLabelProps={{ shrink: true }}
