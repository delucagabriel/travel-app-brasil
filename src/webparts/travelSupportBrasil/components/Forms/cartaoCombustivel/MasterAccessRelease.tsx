...
export default function MasterAccessRelease(){
  ...
  const [novoGestorDaBase, setNovoGestorDaBase] = useState<IEmployee>();
  ...
  const handleGetNovoGestorDaBase = value => getEmployee("IAM_ACCESS_IDENTIFIER", value.toUpperCase())
  .then(emp => {
    setNovoGestorDaBase(emp);
  ...
  const handleGetNovoGestorDaBaseByEmail = value => getEmployee("WORK_EMAIL_ADDRESS", value.toLowerCase())
  .then(emp => {
    setNovoGestorDaBase(emp);
    setValue("BENEFICIARIO_ID", emp?emp.IAM_ACCESS_IDENTIFIER:"", {
      shouldDirty: true
    ...
    <Paper>
      <HocDialog>
        <Typography variant='body2'>
          É permitido somente dois acessos máster por base.
        </Typography>
      </HocDialog>
      <div style={{padding:"20px"}}>
        <form onSubmit={handleSubmit(onSubmit)}>
          <Grid container spacing={3} justify="space-between">
            ...
            <Grid item xs={12} sm={6} md={6} lg={6} xl={6}>
              ...
              <Controller
                as={
                  <Select disabled fullWidth>
                    <MenuItem value="Liberação de acesso master">Liberação de acesso master</MenuItem>
                  </Select>
                }
                id="Process"
                name="PROCESSO"
                defaultValue="Liberação de acesso master"
                control={control}
              />
            </Grid>
            ...
            <Grid item xs={12} sm={4} md={4} lg={4} xl={4} >
                <TextField
                  ...
                  label="Novo empregado com acesso master: Matrícula"
                  onBlur={ e=> handleGetNovoGestorDaBase(e.target.value) }
                  inputRef={register}
                  InputLabelProps={{ shrink: true }}
              ...
              <Grid item xs={12} sm={8} md={8} lg={8} xl={8} >
                <TextField
                  ...
                  label="Novo empregado com acesso master: e-mail"
                  variant="outlined"
                  inputRef={register}
                  onBlur={ e=> handleGetNovoGestorDaBaseByEmail(e.target.value) }
                  InputLabelProps={{ shrink: true }}
              ...
              <Grid item xs={12} sm={12} md={12} lg={12} xl={12} >
                <TextField disabled fullWidth type="text" name="BENEFICIARIO_NOME"
                  label="Novo empregado com acesso master: Nome" variant="outlined"
                  inputRef={register}
                  InputLabelProps={{ shrink: true }}
            ...
            <Grid item xs={12} sm={12} md={12} lg={12} xl={12} >
              <TextField type="text" name="CODIGO_DA_BASE"
          ...
          <Input inputRef={register} readOnly type="hidden" name="BENEFICIARIO_EMPRESA_COD" value={novoGestorDaBase && novoGestorDaBase.COMPANY_CODE } />
          <Input inputRef={register} readOnly type="hidden" name="BENEFICIARIO_EMPRESA_NOME" value={novoGestorDaBase && novoGestorDaBase.COMPANY_DESC } />
